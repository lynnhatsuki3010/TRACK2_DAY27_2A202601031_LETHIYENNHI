...
def get_column_downstream(
    ...
    Same traversal as get_downstream_assets, applied to column-qualified
    node ids (e.g. "table.column") so column-level blast radius works even
    when a column feeds multiple derived columns across several hops.
    """
